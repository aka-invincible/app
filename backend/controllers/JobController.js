 ...
 * Expects `req.params.id` to contain the MongoDB job document ID.
 * Returns 200 with the job data when found, 404 when not found,
 * and 500 on database or server errors.
 */
